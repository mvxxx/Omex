...
//			// Assert.
//			Assert.AreEqual(expectedSfHealthState, publisherContext.ReportedSfHealthInformation(HealthCheckPublisher.HealthReportSummaryProperty)?.HealthState);
//		}
...
//			SfHealthInformation? summaryInfo = publisherContext.ReportedSfHealthInformation(HealthCheckPublisher.HealthReportSummaryProperty);
...
//			Assert.AreEqual(HealthCheckPublisher.HealthReportSummaryProperty, summaryInfo.Property, "Property from report is incorrect.");
